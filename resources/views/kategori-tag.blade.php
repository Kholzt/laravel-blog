    ...
    <div class="">
        ...
        <div class="relative min-h-screen flex flex-col items-center justify-start selection:bg-[#FF2D20] selection:text-black">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6 ">
                    <div class="md:max-w-2xl mx-auto flex justify-center items-center">
                        <div class="text-start">
                            <span class="text-white  text-lg">{{$data->type}}</span>
                            <h1 class="text-white text-5xl capitalize text-center mb-10">{{$data->key}}</h1>
                        </div>
                    </div>
